...
ENEMIES_DATA = [
	...
	(208, 112, 208, 96, 0, -2, 5),
    # 5 WEST CORRIDOR
	(32, 48, 192, 48, 2, 0, 1),
	(192, 80, 32, 80, -2, 0, 1),
	(144, 128, 160, 128, 2, 0, 5),
	...
	(80, 16, 80, 128, 0, 4, 3),
	(192, 128, 208, 128, 2, 0, 5),
    # 10 WEST CORRIDOR
	(128, 128, 144, 128, 2, 0, 5),
	(176, 64, 160, 16, -2, -2, 3),
	(32, 16, 16, 64, -2, 2, 3),
    # 11 SUPPLY DEPOT 2
	(160, 80, 32, 80, -4, 0, 1),
    ...
    #-----------LEVEL 3-------------
    # 30 PELUSOIDS LAIR
	(80, 128, 112, 128, 2, 0, 5),
	(112, 112, 144, 112, 2, 0, 29),
	(0, 0, 0, 0, 0, 0, 0),
    # 31 ALVARITOS GROTTO 2
	(192, 64, 32, 32, -2, -2, 2),
